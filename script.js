...
function adminRender(tab='overview'){
 const c=document.getElementById('adminContent');if(!c)return;const tasks=loadTasks(),cfg=getSiteConfig();let storedCash={};try{storedCash=JSON.parse(localStorage.getItem('xi-class-finance-v3')||'{}')}catch{}const cash=Object.assign({balance:0,income:0,expense:0,note:'Data kas kelas'},cfg.cash||{},storedCash||{});
